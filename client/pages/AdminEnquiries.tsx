...
export default function AdminEnquiries() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'quoted': return <Car className="w-3 h-3" />;
    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Manage tour bookings and travel enquiries</p>
        </div>
            ...
            <CardContent className="pt-0">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                <div className="bg-blue-50 rounded-lg p-3">
                  ...
                  <p className="text-sm font-medium text-gray-900">{enquiry.pickupLocation}</p>
                </div>
                ...
                <div className="bg-green-50 rounded-lg p-3">
                  ...
                  <p className="text-sm font-medium text-gray-900">{enquiry.destination}</p>
                </div>
                ...
                <div className="bg-purple-50 rounded-lg p-3">
                  ...
                  <p className="text-sm font-medium text-gray-900">{enquiry.travelDate}</p>
                </div>
                ...
                <div className="bg-orange-50 rounded-lg p-3">
                  ...
                  <p className="text-sm font-medium text-gray-900">{enquiry.passengers}</p>
                </div>
              </div>
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              {searchTerm || statusFilter !== 'all' ? 'No matching enquiries found' : 'No enquiries yet'}
            </h3>
