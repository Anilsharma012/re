...
export default function AdminContacts() {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'responded': return <MessageSquare className="w-3 h-3" />;
    ...
    <div className="p-6">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600">Manage customer contact messages and enquiries</p>
        </div>
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              {searchTerm || statusFilter !== 'all' ? 'No matching contacts found' : 'No contacts yet'}
            </h3>
