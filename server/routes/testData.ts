    ...
    const sampleContacts = [
      {
        ...
        message: "Hi, I'm interested in a 5-day tour package to Rajasthan for my family of 4. Could you please provide details and pricing?",
        status: "new",
      ...
      },
      {
        ...
        message: "I need to book an Innova for a one-day local sightseeing in Jaipur. What are your rates?",
        status: "responded",
      ...
      },
      {
        ...
        message: "We need transportation for our company outing for 25 people. Please share your packages.",
        status: "new",
    ...
    const sampleEnquiries = [
      {
        ...
        passengers: "4",
        vehicleType: "SUV",
        message: "Planning a family trip to Agra. Need pickup from IGI Airport and full day tour.",
        status: "new",
      ...
      },
      {
        ...
        message: "Religious trip to Shirdi for elderly people. Need comfortable vehicle.",
        status: "quoted",
